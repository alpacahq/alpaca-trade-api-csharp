...
[DebuggerDisplay("{DebuggerDisplay,nq}", Type = nameof(IReverseSplit))]
[SuppressMessage(
    "Microsoft.Performance", "CA1812:Avoid uninstantiated internal classes",
    Justification = "Object instances of this class will be created by Newtonsoft.JSON library.")]
internal sealed class JsonReverseSplit : IReverseSplit
{
    ...
    private String DebuggerDisplay =>
        $"{nameof(IReverseSplit)} {{ Symbol = {Symbol}, NewRate = {NewRate}, OldRate = {OldRate} }}";
}
