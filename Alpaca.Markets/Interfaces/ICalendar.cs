...
namespace Alpaca.Markets
{
    ...
    public interface ICalendar
    {
        ...
        /// </summary>
        [Obsolete("This property will be removed in the next major release. Use the TradingDateUtc property instead.", true)]
        ...
        /// </summary>
        [Obsolete("This property will be removed in the next major release. Use the TradingOpenTimeUtc property instead.", true)]
        ...
        /// </summary>
        [Obsolete("This property will be removed in the next major release. Use the TradingCloseTimeUtc property instead.", true)]
