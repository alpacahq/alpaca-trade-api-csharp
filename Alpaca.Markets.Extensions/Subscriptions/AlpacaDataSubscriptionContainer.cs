    ...
    : IAlpacaDataSubscription<TItem>
{
    ...
    public IEnumerable<String> Streams => _subscriptions.SelectMany(subscription => subscription.Streams);

    public Boolean Subscribed => _subscriptions.All(subscription => subscription.Subscribed);
