...
public static partial class AlpacaDataStreamingClientExtensions
{
    ...
    /// <summary>
    /// Gets the order imbalance subscription for the all assets from the <paramref name="symbols"/> list.
    /// </summary>
    /// <param name="client">Target instance of the <see cref="IAlpacaDataStreamingClient"/> interface.</param>
    /// <param name="symbols">Alpaca asset names list (non-empty) for order imbalance updates subscribing.</param>
    /// <exception cref="ArgumentNullException">
    /// The <paramref name="client"/> or <paramref name="symbols"/> argument is <c>null</c>.
    /// </exception>
    /// <exception cref="OverflowException">
    ...
    [UsedImplicitly]
    [CLSCompliant(false)]
    public static IAlpacaDataSubscription<IOrderImbalance> GetOrderImbalanceSubscription(
        this IAlpacaDataStreamingClient client,
        params String[] symbols) =>
        getOrderImbalanceSubscription(
            client.EnsureNotNull(),
            symbols.EnsureNotNull());
    ...
    /// </summary>
    /// <param name="client">Target instance of the <see cref="IAlpacaDataStreamingClient"/> interface.</param>
    /// <param name="symbol">Alpaca asset name for order imbalance updates subscribing.</param>
    /// <exception cref="ArgumentNullException">
    /// The <paramref name="client"/> or <paramref name="symbol"/> argument is <c>null</c>.
    /// </exception>
    /// <exception cref="OverflowException">
    ...
    [UsedImplicitly]
    [CLSCompliant(false)]
    public static ValueTask<IDisposableAlpacaDataSubscription<IOrderImbalance>> SubscribeOrderImbalanceAsync(
        this IAlpacaDataStreamingClient client,
        String symbol) =>
        DisposableAlpacaDataSubscription<IOrderImbalance>.CreateAsync(
            client.EnsureNotNull().GetOrderImbalanceSubscription(symbol.EnsureNotNull()),
            client.EnsureNotNull());

    /// <summary>
    /// Gets the order imbalance subscription for all assets from the <paramref name="symbols"/> list.
    /// This subscription is returned with pending subscription state and will be unsubscribed on disposing
    /// so you can use it inside the <c>using</c> or <c>await using</c> statements for more clear resource management.
    /// </summary>
    /// <param name="client">Target instance of the <see cref="IAlpacaDataStreamingClient"/> interface.</param>
    ...
    public static ValueTask<IDisposableAlpacaDataSubscription<IOrderImbalance>> SubscribeOrderImbalanceAsync(
        ...
        params String[] symbols) =>
        DisposableAlpacaDataSubscription<IOrderImbalance>.CreateAsync(
            client.EnsureNotNull().GetOrderImbalanceSubscription(symbols.EnsureNotNull()),
            client.EnsureNotNull());
    ...
    private static AlpacaDataSubscriptionContainer<IOrderImbalance> getOrderImbalanceSubscription(
        IAlpacaDataStreamingClient client,
        IEnumerable<String> symbols) =>
        getSubscription(client.GetOrderImbalanceSubscription, symbols);
